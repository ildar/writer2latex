...
public class XMLString {
	...
	public static final String DRAW_CAPTION_POINT_X = "draw:caption-point-x";
	public static final String DRAW_CAPTION_POINT_Y = "draw:caption-point-y";
	...
	public static final String DRAW_TEXTAREA_HORIZONTAL_ALIGN = "draw:textarea-horizontal-align";
	public static final String DRAW_TEXTAREA_VERTICAL_ALIGN = "draw:textarea-vertical-align";
	...
	// public static final String TEXT_NOTE="text:note"; defined above as an
	// element name
	...
	public static final String SVG_D = "svg:d";
